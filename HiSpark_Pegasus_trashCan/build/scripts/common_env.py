...
set_config('env_cfg', 'CONFIG_OHOS', 'y', ['CONFIG_OHOS', ('HOS_PRODUCT_TYPE', r'\"\"'), ('HOS_SERIAL', r'\"\"'), ('HOS_MANUFACTURE', r'\"\"'),
    ...
    ('HOS_SECURITY_PATCH_TAG', r'\"\"'), ('HOS_ABI_LIST', r'\"\"'), ('HOS_INCREMENTAL_VERSION', r'\"OHOS_2.0.1.28\"'),
    ('HOS_BUILD_TYPE', r'\"release\"'), ('HOS_BUILD_USER', r'\"jenkins\"'), ('HOS_BUILD_TIME', r'\"2020-09-15_15:30:38\"'),
